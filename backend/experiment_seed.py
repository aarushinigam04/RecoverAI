...
EXPERIMENT_PAYMENTS = 100
EXPERIMENT_PREFIX = "RECOVERAI-EXP-"

# Separate seed so this experiment is reproducible
random.seed(2026)
...
try:
    ...
    print("=" * 60)
    print("RecoverAI isolated experiment dataset")
    print("=" * 60)

    # =====================================================
    # 1. CREATE EXPERIMENT CUSTOMERS
    # =====================================================

    customers = []

    for i in range(1, EXPERIMENT_PAYMENTS + 1):
        ...
        customer = Customer(
            ...
            email=f"experiment_customer{i}@recoverai.test"
        )
    ...
    print(f"Created experiment customers: {len(customers)}")


    # =====================================================
    # 2. CREATE EXPERIMENT PAYMENTS
    # =====================================================
    ...
    for i in range(1, EXPERIMENT_PAYMENTS + 1):
        ...
        payment = Payment(
            ...
            currency="INR",
            status="failed",
            order_id=f"{EXPERIMENT_PREFIX}{i:04d}",
    ...
    print(f"Created experiment payments: {len(payments)}")


    # =====================================================
    # 3. CREATE INITIAL PAYMENT ATTEMPTS
    # =====================================================
    ...
    print(f"Created experiment attempts: {len(attempts)}")
    ...
    print(f"Created experiment recovery cases: {len(recovery_cases)}")


    # =====================================================
    # 5. CREATE INITIAL RECOVERY ACTIONS
    # =====================================================
    ...
    print()
    print("=" * 60)
    print("ISOLATED EXPERIMENT DATASET CREATED")
    print("=" * 60)
    ...
    print()
    print(
        "IMPORTANT: Existing RECOVERAI-ORD-0001 to "
        "RECOVERAI-ORD-0500 data was not deleted."
    )
    ...
    print()
    print("ERROR while creating experiment dataset:")
    print(e)
